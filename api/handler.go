...
// @Accept         json
// @Produce        json
// @Param          active query   bool  false  "Filter by active students"
...
func (api *API) getStudents(c echo.Context) error {
	...
	if active != "" {
		...
		students, err = api.DB.GetFilterStudent(act)
		if err != nil {
			log.Error().Err(err).Msgf("[api] error to filtred students")
		}
	}
...
func (api *API) createStudent(c echo.Context) error {
	...
	return c.JSON(http.StatusOK, "create student")
}
...
// @Produce        json
// @Param          id        path   int              true  "Student ID"
// @Param          student   body   schemas.Student  true  "Updated student data"
// @Success        200 {object} schemas.StudentResponse
// @Failure        404
// @Failure        500
...
func (api *API) updateStudent(c echo.Context) error {
	...
	if err := api.DB.UpdateStudent(student); err != nil {
		c.String(http.StatusInternalServerError, "Failed to save student")
	}
